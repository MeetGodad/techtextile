  ...
  return (
    <div className="w-full min-h-screen bg-white p-8 text-black">
      ...
      <form onSubmit={handleSubmit} className="space-y-6 text-black">
        ...
        <div className="flex justify-end space-x-4">
          <button type="button" onClick={onClose} className="bg-gradient-to-r from-gray-900 to-gray-700 text-white px-4 py-2 rounded-lg hover:from-gray-800 hover:to-gray-600 transition duration-300">Cancel</button>
          <button type="submit" className="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors duration-200">Update Info</button>
        </div>
      </form>
    </div>
