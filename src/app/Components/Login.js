...
export default function Login() {
    return (
      <div className="flex w-full h-full">
        ...
        <div className="[text-decoration:none] absolute top-[702px] left-[221px] text-2xl font-inter text-[inherit] inline-block w-[295px] h-[42px]">
         <Link href="createaccount">Don’t have the account?</Link> 
        </div>
      </div>
