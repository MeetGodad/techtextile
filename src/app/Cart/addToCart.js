                ...
                >
                  ...
                  <div className="mb-6">
                    ...
                    <input
                      ...
                      value={item.quantity}
                      onChange={(e) => {
                        const variantIds = item.selected_variants && item.selected_variants.length > 0
                          ? item.selected_variants.map(v => v.variant_id)
                          : null;
                        console.log('Item:', item.product_name);
                        console.log('Has variants:', !!variantIds);
                        updateQuantity(item.cart_item_id, e.target.value, variantIds);
                      }}
                    />
