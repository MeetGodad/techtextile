...
const Header = () => {
  ...
  return (
    <div className="w-full bg-white overflow-hidden flex flex-row items-center justify-between py-0 px-3 box-border top-0 sticky leading-normal tracking-normal gap-3 text-left text-xl text-black font-sans z-50" style={{ borderBottom: '2px solid black' }}>
