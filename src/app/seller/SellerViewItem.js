          ...
          {items.length === 0 ? (
            ...
            items.map((item, index) => {
              ...
              return (
                <div 
                  key={item.product_id} 
                  className={`bg-gray-100 rounded-lg shadow-lg p-4 relative transition transform hover:scale-105 ${isDeleted ? 'bg-gray-100 opacity-50' : 'bg-white'}`}
                >
                  ...
                  <div className="mt-4">
                    ...
                    <button
                      className="mt-4 w-full bg-gradient-to-r from-gray-900 to-gray-700 text-white px-4 py-2 rounded-lg hover:from-gray-800 hover:to-gray-600 transition duration-300"
